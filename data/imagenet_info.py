...
CLEAN_IMG_PATH = 'imagenet/val'
CORRUPT_IMG_PATH = 'imagenet-c'
...
# These two are different because the corrupt images have already been cropped to (224,224)
CORRUPT_TRANSFORM = torchvision.transforms.Compose([
    torchvision.transforms.Resize(256),
    torchvision.transforms.ToTensor(),
    ])

FHM_IMAGE_SIZE= (256, 256) # square image

# Same as clean transform except image is cropped to square
FHM_CLEAN_TRANSFORM = CLEAN_TRANSFORM
